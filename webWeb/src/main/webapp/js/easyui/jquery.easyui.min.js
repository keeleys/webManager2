...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"此项必须填写.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入正确的邮箱."},url:{validator:function(_443){
...
},message:"请输入正确的URL."},length:{validator:function(_444,_445){
