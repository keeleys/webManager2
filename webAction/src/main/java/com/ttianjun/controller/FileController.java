...
public class FileController extends BaseController<FileBox> {
    ...
    public void up() {
        ...
        if(upfilelist!=null&&upfilelist.isEmpty()==false){
            ...
            for(UploadFile upfile:upfilelist){
                ...
                savefilename =  subdir+"/"+new Date().getTime()+"."+filetype ;
        ...
        if(upfilelist!=null&&upfilelist.isEmpty()==false){
            ...
            for(UploadFile upfile:upfilelist){
                ...
                if(file != null){
                    ...
                    savefilename =  new Date().getTime()+"."+ftype;
                    fbattrs.put("filepath",savefilename);
